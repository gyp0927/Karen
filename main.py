...
# ── 像素头像（ANSI 256 色背景）─────────────────────────────
# 头发：从白高光 → 亮粉 → 鲜艳粉 → 深粉 → 暗粉轮廓，层次更鲜明
# 肤色：偏暖，更自然
# 衣服：薄荷绿，清新对比
# 发带：品红，更醒目
_AVATAR_BG = {
    "H": "\033[48;5;231m",  # 粉白-头发高光（最亮）
    "h": "\033[48;5;225m",  # 亮粉-头发主体
    "n": "\033[48;5;213m",  # 鲜艳粉-头发过渡
    "d": "\033[48;5;205m",  # 深粉-头发阴影
    "D": "\033[48;5;168m",  # 暗粉-轮廓
    "r": "\033[48;5;201m",  # 品红-发带（亮眼）
    "s": "\033[48;5;230m",  # 暖肤色
    "e": "\033[48;5;233m",  # 深灰-瞳孔（柔和）
    "w": "\033[48;5;15m",   # 白-眼睛高光
    "c": "\033[48;5;152m",  # 薄荷绿-衣服（清新）
    "b": "\033[48;5;211m",  # 腮红粉
}

# 新设计：更圆润的头部轮廓，更紧凑的面部，头发层次更丰富
_AVATAR_PIXELS = [
    [" ", " ", " ", " ", "D", "d", "h", "H", "H", "H", "h", "d", "D", " ", " ", " ", " ", " "],
    [" ", " ", " ", "D", "h", "H", "H", "H", "H", "H", "H", "h", "d", "D", " ", " ", " ", " "],
    [" ", " ", "D", "h", "H", "H", "n", "n", "n", "H", "H", "H", "h", "d", "D", " ", " ", " "],
    [" ", "D", "h", "H", "H", "n", "s", "s", "s", "n", "H", "H", "H", "h", "d", " ", " ", " "],
    [" ", "D", "h", "H", "n", "s", "s", "e", "w", "s", "n", "H", "H", "h", "d", " ", " ", " "],
    [" ", " ", "d", "h", "n", "s", "s", "b", "s", "s", "n", "H", "h", "d", " ", " ", " ", " "],
    [" ", " ", " ", "d", "n", "s", "s", "s", "s", "s", "n", "h", "h", "d", " ", " ", " ", " "],
    [" ", " ", " ", " ", "d", "h", "n", "r", "r", "r", "n", "h", "d", "d", " ", " ", " ", " "],
    [" ", " ", " ", " ", " ", "d", "h", "h", "s", "h", "h", "d", " ", " ", " ", " ", " ", " "],
    [" ", " ", " ", " ", " ", " ", "c", "c", "c", "c", "c", " ", " ", " ", " ", " ", " ", " "],
    [" ", " ", " ", " ", " ", "c", "c", "c", "c", "c", "c", "c", " ", " ", " ", " ", " ", " "],
