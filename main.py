...
# ── 像素头像（ANSI 256 色背景）─────────────────────────────
# 粉色魔法法杖：宝石光芒 → 亮粉边框 → 粉紫杖身 → 暗紫螺旋 → 深紫底座
_AVATAR_BG = {
    "H": "\033[48;5;231m",  # 粉白-光芒（最亮）
    "h": "\033[48;5;219m",  # 亮粉-宝石边框
    "s": "\033[48;5;205m",  # 热粉-宝石中心
    "n": "\033[48;5;213m",  # 粉红-杖身主体
    "d": "\033[48;5;176m",  # 中紫粉-杖身纹理
    "b": "\033[48;5;170m",  # 暗紫粉-螺旋装饰
    "D": "\033[48;5;98m",   # 深紫-底座
}

# 法杖设计：顶部宝石 → 杖身 → 螺旋纹理 → 底座
_AVATAR_PIXELS = [
    [" ", " ", " ", " ", " ", " ", " ", "h", "h", "h", "h", " ", " ", " ", " ", " ", " ", " "],
    [" ", " ", " ", " ", " ", " ", "h", "h", "H", "H", "h", "h", " ", " ", " ", " ", " ", " "],
    [" ", " ", " ", " ", " ", " ", "h", "H", "s", "s", "H", "h", " ", " ", " ", " ", " ", " "],
